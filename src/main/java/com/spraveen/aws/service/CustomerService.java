...
public class CustomerService {
    ...
    public CustomerService(@Value("${app.csv.batch-size}") int batchSize, CustomerRepository customerRepository, S3Service s3Service) {
    ...
    private String generateCsvContent() throws CsvGenerationException {
        ...
        try (CSVPrinter csvPrinter = new CSVPrinter(stringWriter, CSVFormat.DEFAULT
            ...
            Page<Customer> firstPage = customerRepository.findCustomersInBatches(PageRequest.of(0, batchSize));
            long totalRecords = firstPage.getTotalElements();
            int totalPages = firstPage.getTotalPages();
            
            log.info("Starting CSV export with batch size: {}, total records: {}, total pages: {}", 
                    batchSize, totalRecords, totalPages);
            ...
            for (int pageNumber = 0; pageNumber < totalPages; pageNumber++) {
                ...
                Page<Customer> page = pageNumber == 0 ? firstPage : 
